...
class OrderItem(models.Model):
    ...
    sizeproduct = models.ForeignKey(to=SizeProductRelation, on_delete=models.SET_DEFAULT, null=True, verbose_name="Продукт",
                                default=None)
    ...
    def products_price(self):
        return round(self.sizeproduct.product.sell_price() * self.quantity, 2)
